...
def extract_GRANT_permits(year):
    base_url = "https://landrecords.co.grant.wi.gov/GCSWebPortal/Search.aspx"
    ...
    # Step 2: POST form with selections
    form_data = {
        "__EVENTTARGET": "",
        "__EVENTARGUMENT": "",
        ...
        "ctl00$cphMainApp$PermitSearchCriteria1$DropDownListDepartment": "SANITATION Department",
    ...
    # Step 4: Add coordinates by querying ArcGIS API
